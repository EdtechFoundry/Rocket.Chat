...
RocketChat.settings.addGroup 'Layout', ->
	...
	@section 'Content', ->
		...
		@add 'Layout_Sidenav_Footer', '<div><a href="" class="logo"> <img src="images/logo/logo.svg" /></a></div>', { type: 'code', code: 'text/html', public: true, i18nDescription: 'Layout_Sidenav_Footer_description' }
